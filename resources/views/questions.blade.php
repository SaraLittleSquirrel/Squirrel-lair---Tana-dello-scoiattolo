...
<div class="row-fluid">
    <div class="accordion" id="accordionQuestions">
        ...
        {{-- domanda 4 come creo una scheda --}}
        <div class="accordion-item">
        ...
        {{-- domanda 5 come creo una esercizio --}}
        <div class="accordion-item">
        ...
        {{-- domanda 6 come posso vedere le mie schede e i miei esercizi --}}
        <div class="accordion-item">
        ...
        {{-- domanda 7 come metto gli esercizi --}}
        <div class="accordion-item">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine"
                data-bs-parent="#accordionQuestions">
                <div class="accordion-body">
                    Sono due metodi principali per impostare uno schema di progressione. Se ci saranno molte richieste, ne potremmo aggiungere altri. <br> <br>
                    Wave =
        ...
        {{-- domanda 10 tempi di recupero sec--}}
        <div class="accordion-item">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingEleven">
                <button class="accordion-button collapsed" style="color:#ce6324" type="button" data-bs-toggle="collapse"
                    ...
                    Il sito non funziona / vorrei fornire ulteriori suggerimenti. Come posso contattarvi?
                </button>
            </h2>
            <div id="collapseEleven" class="accordion-collapse collapse" aria-labelledby="headingEleven"
                data-bs-parent="#accordionQuestions">
                <div class="accordion-body">
                    Scrivici pure a questa <a href="mailto:s.derosa001@studenti.unibs.it" class="link link-dark">mail</a>.
                </div>
            </div>
        </div>
    </div>
